      ...
      <main>
          ...
          <div className="container-content">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <ul className="space-y-3 font-noto-serif text-sm text-grace-text-secondary">
                  {[
          ...
          <div className="container-content">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              ...
              <div className="bg-grace-offwhite p-8 border border-grace-line">
                ...
                <ul className="mt-4 space-y-1 font-noto-serif text-xs text-grace-text-tertiary">
                  <li>御祝・御礼・粗品・寸志</li>
                  <li>内祝・快気祝・引き出物</li>
                  <li>その他ご要望に対応可能</li>
                </ul>
              ...
              <div className="bg-grace-offwhite p-8 border border-grace-line">
                ...
                <p className="mt-4 font-noto-serif text-xs text-grace-text-tertiary">
                  文字数: 最大100文字程度<br />
                  ご注文時の備考欄にご記入ください
                </p>
              </div>
              ...
              <dl className="space-y-4">
                {[
                  ...
                  <div key={label} className="flex gap-4 py-3 border-b border-grace-line">
                    ...
                    <dd className="font-noto-serif text-sm text-grace-text-secondary">{value}</dd>
                  </div>
                ))}
              </dl>
            </div>
        ...
        <section className="section-padding bg-grace-bg-dark">
          <div className="container-content text-center">
            ...
            <p className="font-noto-serif text-sm text-grace-stone leading-loose mb-10 max-w-md mx-auto">
