              ...
              <div>
                ...
                <div className="space-y-6 mb-8">
                  {[
                    ...
                    <div key={label}>
                      ...
                      <p className="font-noto-serif text-sm text-grace-text-secondary leading-loose">{text}</p>
                    </div>
                  ))}
                </div>
                ...
                {product.squareUrl ? (
                  ...
                  <div className="bg-grace-cream border border-grace-line p-4 text-center mb-3">
                    <p className="font-noto-serif text-xs text-grace-text-secondary">
                      この商品は店頭でのみご購入いただけます
                    </p>
                  </div>
                )}
                ...
                <dl className="space-y-4">
                  {product.ingredients && product.ingredients.length > 0 && (
                    <div>
                      ...
                      <dd className="font-noto-serif text-xs text-grace-text-secondary leading-relaxed">
                  ...
                  {product.expiryDate && (
                    <div>
                      ...
                      <dd className="font-noto-serif text-xs text-grace-text-secondary">{product.expiryDate}</dd>
                    </div>
                  )}
                  {product.storageMethod && (
                    <div>
                      <dt className="font-noto-sans text-[10px] tracking-widest text-grace-text-tertiary mb-1">保存方法</dt>
                      <dd className="font-noto-serif text-xs text-grace-text-secondary">{product.storageMethod}</dd>
                    </div>
                  )}
                </dl>
              </div>
