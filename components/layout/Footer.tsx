        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            <Image
              ...
              className="mb-4"
            />
            <p className="font-noto-serif text-xs text-grace-text-tertiary leading-relaxed tracking-wide">
              美しい暮らしには、お菓子がある。
            </p>
          </div>
                ...
                <li key={href}>
                  {external ? (
                    <a
                      ...
                      className="font-noto-serif text-xs text-grace-text-secondary hover:text-grace-brown transition-colors"
                    >
                      {label}
                    </a>
                  ) : (
          ...
          <div>
            ...
            <address className="not-italic font-noto-serif text-xs text-grace-text-secondary leading-relaxed mb-6">
              〒486-0844<br />
              愛知県春日井市<br />
              営業時間 9:30–19:30<br />
              不定休
